...
Scheme
{
    ...
    Fonts
	{
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
			...
			{
				"name"         "ocra" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Arial MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "ocra Console" [$X360]    //"Lucida Console"
                "name"         "ocra" [$POSIX] // Apple Mac OS "Verdana" (default) Best small font = "Georgia" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "11" [$POSIX]  // "11"
                ...
                "tall_lodef" "11" //"15"
                "tall_hidef" "11" //"20" 
                "weight"     "1000"  //"0" // This is the thickness, like a bold setting max is about 700. Small fonts will look better as "0".
			...
			{ // for my 1920x1080 screen:
				// fonts:
				// ocra is a good option
				// (default font) Lucida Console is ok but jitters side to side mainly where the lerp number is 
				// Arial sucks
				// Microsoft Sans Serif os ok but still movement
				// Georgia terrible dats like a book reading font
				// Impact os movement
				// Arial MT not bad still a little movement
				"name"         "ocra" [$WINDOWS] //
                "name"         "ocra" [$X360]    //"Lucida Console"
                "name"         "ocra" [$POSIX] // Apple Mac OS "Verdana" (default) Best small font = "Georgia" Mac Installation location: /Library/Fonts and is default on Mac OS
				"tall"         "22" [$POSIX]  // "11"                
                "tall"         "22"  // good positioning is ... net_graphheight 87 and net_graphpos 210 and ensure you select "outline" "1" with all others off with Ariel font.
                "tall_lodef" "22" //"15"
                "tall_hidef" "22" //"20"                
                "weight"     "1000"
                "range"         "0x0000 0x017F" //    Basic Latin, Latin-1 Supplement, Latin Extended-A
			...
			"5" //For screen heights between 1200 and 6000 (6000...wow that's freaking huge!) (eg 4:3 aspect Width 1600X1200 High... 16:10 aspect Width 1920x1200 High.... and beyond) 
			{
			    "name"         "ocra" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Arial MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "ocra Console" [$X360]    //"Lucida Console"
                "name"         "ocra" [$POSIX] // Apple Mac OS "Verdana" (default) Best small font = "Georgia" and "Arial" Mac Installation location: /Library/Fonts and is default on Mac OS
                "tall"         "24" [$POSIX]  // "11"                
                "tall"         "24" // good positioning is ... net_graphheight 95 and net_graphpos 225 and ensure you select "outline" "1" with all others off with Ariel font.
                "tall_lodef" "24" //"15"
                "tall_hidef" "24" //"20"                
                "weight"     "1000"
                "range"         "0x0000 0x017F" //    Basic Latin, Latin-1 Supplement, Latin Extended-A
